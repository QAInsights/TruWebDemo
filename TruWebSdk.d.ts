// Type definitions for [TruWeb SDK] [2018.11]
// Project: [TruWeb]
...
declare namespace load {
    ...
    export class config {
        userId: string; // The id of the currently running Vuser
        script: {
            name: string;
            directory: string;
            fullPath: string;
    ...
    /**
     *Registers the given callback to be run in the initialization phase of the test.
     The callback may return a promise that will be used to determine if the callback has succeeded or failed.
     *
     * @export
